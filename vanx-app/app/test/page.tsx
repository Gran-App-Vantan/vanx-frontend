...
export default function Test() {
  return (
    <div className="font-sans pt-6 px-6 bg-accent-light flex flex-col gap-8">
    ...
    <div className="flex justify-end gap-6 text-label mt-9">
      <p className="pt-2 not-italic">100位</p>
