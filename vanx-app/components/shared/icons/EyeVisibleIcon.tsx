...
export function EyeVisibleIcon({
  ...
  return (
    isClicked ? (
      ...
      >
        <path d="M21.257 10.962C21.731 11.582 21.731 12.419 21.257 13.038C19.764 14.987 16.182 19 12 19C7.818 19 4.236 14.987 2.743 13.038C2.51205 12.7413 2.38666 12.376 2.38666 12C2.38666 11.624 2.51205 11.2587 2.743 10.962C4.236 9.013 7.818 5 12 5C16.182 5 19.764 9.013 21.257 10.962Z" stroke="#1A1A1A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
